...
\begin{figure}[htb]
	\begin{center}
		...
		\subfloat[]{\includegraphics[width=0.75\columnwidth]{figs/hailpad_network_ptbr.png}
			\label{rede_hailpads}}
		\ \
...
Como houve no máximo 2 placas sensibilizadas em todos os casos (quantidade insuficiente para inferir a energia cinética do granizo), calculou-se a energia cinética do \textit{hailpad} $E_t\:(Jm^{-2})$, definida por \citeonline{Waldvogel1978} como:
...
\begin{figure}[htb]
	\begin{center}
		...
		\legend{Fonte: Adaptado de \citeonline{Rauber2018}.}
	\end{center}
\end{figure}
