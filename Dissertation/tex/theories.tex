...
\begin{figure}[htb]
	\begin{center}
		...
		\subfloat[]{\includegraphics[width=0.35\columnwidth]{figs/tripole_normal_ptbr.png}
			\label{tripolar_normal}}
		\subfloat[]{\includegraphics[width=0.35\columnwidth]{figs/tripole_opposite_ptbr.png}
