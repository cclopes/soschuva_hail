...
Tempestades de granizo são interessantes por causarem danos à superfície em diferentes escalas e graus de intensidade - afinal, é a queda de granizo que separa tempestades de granizo de tempestades não-severas. Porém, medir esse granizo na superfície não é tarefa fácil: o melhor instrumento \textit{in-situ} para medir granizo é chamado de \textit{hailpad} e foi desenvolvido por \citeonline{Schleusener1960a} e \citeonline{Decker1961}. Constituído por uma placa de isopor que pode estar fixada próximo à superfície ou em um suporte a certa altura, o impacto do granizo na placa deixa uma cavidade que pode ser estimada como o diâmetro desse granizo, e após o evento essa placa fornece uma distribuição de tamanho de granizo. Essa distribuição de tamanho
