...
\local{São Paulo}
\data{2019}
\orientador{Profª Drª Rachel Ifanger Albrecht}
\instituicao{%
...
\preambulo{Dissertação apresentada ao Departamento de Ciências Atmosféricas do Instituto de Astronomia, Geofísica e Ciências Atmosféricas da Universidade de São Paulo como requisito parcial para a obtenção do título de Mestre em Ciências.}
% ---
