...
#     grid_2, file_name='../Data/REANALYSIS/ERA5/era5_plevs_20170314.nc',
#     vel_field='VT'
# )

# - Retrieving!
Grids = pydda.retrieval.get_dd_wind_field(
    [grid_1, grid_2], u_init, v_init, w_init, Co=1., Cm=1500., Cz=0,
    # Cv=1e-4, Ut=-10., Vt=-10.,
    vel_name='VT', refl_field='DT', frz=cv.zero_height, filt_iterations=0,
    mask_outside_opt=True
)

pyart.io.write_grid('grid1_SR-FCTH.nc', Grids[0])
pyart.io.write_grid('grid2_SR-FCTH.nc', Grids[1])
